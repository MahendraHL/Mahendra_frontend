                ...
                <tbody>
                    {products.map(product => (
                        <tr key={product._id}>
                            ...
                            <td>{product.date}</td>
                            <td>
                                <Button variant="primary" onClick={() => handleEditClick(product._id, product.pName, product.pPrice)}>Edit</Button>{' '}
                                <Button variant="secondary" onClick={() => handleDelete(product._id)}>Delete</Button>
                            </td>
                        </tr>
                    ))}
                </tbody>
